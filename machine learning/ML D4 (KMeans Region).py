...
combined.hvplot.scatter(x="Region", y="Flavor", by="Cluster")
...
# Create a scatterplot of df_coffee
combined.hvplot.scatter(x="Region", y="Aroma", by="Cluster")
...
# Create a scatterplot of df_coffee
combined.hvplot.scatter(x="Region", y="Acidity", by="Cluster")
...
# Create a scatterplot of df_coffee
combined.hvplot.scatter(x="Region", y="Aftertaste", by="Cluster")
